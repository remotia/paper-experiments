...
pub struct YUV420PToBGRAConverter {
    y_buffer_id: String,
    u_buffer_id: String,
    v_buffer_id: String,
...
impl Default for YUV420PToBGRAConverter {
    fn default() -> Self {
        Self::new()
    }
}
...
#[async_trait]
impl FrameProcessor for YUV420PToBGRAConverter {
...
fn yuv_to_bgra_separate(y_pixels: &[u8], u_pixels: &[u8], v_pixels: &[u8], rgba_pixels: &mut [u8]) {
