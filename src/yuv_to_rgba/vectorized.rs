...
use yuv_utils::yuv2rgba::for_loop::vectorized::ConversionContext;

pub struct VectorizedYUV420PToRGBAConverter {
...
impl VectorizedYUV420PToRGBAConverter {
...
#[async_trait]
impl FrameProcessor for VectorizedYUV420PToRGBAConverter {
